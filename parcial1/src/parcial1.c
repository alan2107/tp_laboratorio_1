	...
	if (initCensistas(censistas, MAX_CENSISTAS) == 0
		...
		do {
			...
			if (getInt(&opcion, "\n Ingrese una opción del menú principal: ",
					"Error: la opción ingresada es inválida", 1, 10, -1) == 0) {
				switch (opcion) {
				case 1:
					auxId = setId();
					if (getWords(auxNombre, sizeof(auxNombre),
							"\n Ingrese el nombre: ",
							"Error: el nombre ingresado es inválido", 3) == 0) {
						if (getWords(auxApellido, sizeof(auxApellido),
							...
							if (getInt(&auxDia,
									...
									"Error: el día de nacimiento ingresado es inválido",
									1, 31, 3) == 0) {
								if (getInt(&auxMes,
										"Ingrese el mes de nacimiento: ",
										"Error: el mes de nacimiento ingresado es inválido",
										1, 12, 3) == 0) {
									if (getInt(&auxAnio,
											"Ingrese el año de nacimiento: ",
											"Error: el año de nacimiento ingresado es inválido",
											1922, 2004, 3) == 0) {
										if (getInt(&auxEdad,
												"Ingrese la edad: ",
											...
											if (getWords(auxCalle,
													...
													"Error: la calle del domicilio ingresada es inválida",
													3) == 0) {
												if (getInt(&auxAltura,
														"Ingrese la altura del domicilio: ",
														"Error: la altura del domicilio ingresado es inválido",
														1, 15000, 3) == 0) {
						...
						if (getInt(&idBuscado,
							...
							if ((posicionCensistaEncontrada =
								...
								do {
									submenuModificar();
									if (getInt(&opcion,
											"\nIngrese una opción del submenú modificación: ",
										...
										case 1:
											if (getWords(auxNombre,
													...
													"Error: el nuevo nombre ingresado es inválido",
													3) == 0) {
												strncpy(
										...
										case 2:
											if (getWords(auxApellido,
													...
													"Error: el nuevo apellido ingresado es inválido",
													3) == 0) {
												strncpy(
										...
										case 3:
											do {
												...
												if (getInt(&opcion,
														"\nIngrese la opción del submenú modificar fecha de nacimiento: ",
														"Error: la opción ingresada es inválida",
														1, 4, -1) == 0) {
													switch (opcion) {
													case 1:
														if (getInt(&auxDia,
																"\nIngrese el nuevo día de nacimiento: ",
																"Error: el nuevo día de nacimiento ingresado es inválido",
																1, 31, 3)
																== 0) {
													...
													case 2:
														if (getInt(&auxMes,
																...
																"Error: el nuevo mes de nacimiento ingresado es inválido",
																1, 12, 3)
																== 0) {
													...
													case 3:
														if (getInt(&auxAnio,
																...
																"Error: el nuevo año de nacimiento ingresado es inválido",
																1922, 2004, 3)
																== 0) {
										...
										case 4:
											if (getInt(&auxEdad,
													...
													"Error: la nueva edad ingresada es inválida",
													18, 100, 3) == 0) {
										...
										case 5:
											do {
												...
												if (getInt(&opcion,
														"\nIngrese la opción del submenú modificar domicilio: ",
														"Error: la opción ingresada es inválida",
														1, 3, -1) == 0) {
													switch (opcion) {
													case 1:
														if (getWords(auxCalle,
																...
																"Error: la nueva calle del domicilio ingresada es inválida",
																3) == 0) {
															strncpy(
													...
													case 2:
														if (getInt(&auxAltura,
																...
																"Error: la nueva altura del domicilio ingresada es inválida",
																1, 15000, 3)
																== 0) {
				...
				case 4:
					...
					if (getWords(auxCalle1, sizeof(auxCalle1),
							"\nIngrese la 1° calle: ",
							"Error: la calle ingresada es inválida", 3) == 0) {
						if (getWords(auxCalle2, sizeof(auxCalle2),
								"Ingrese la 2° calle: ",
								"Error: la calle ingresada es inválida", 3)
								== 0) {
							if (getWords(auxCalle3, sizeof(auxCalle3),
								...
								if (getWords(auxCalle4, sizeof(auxCalle4),
										"Ingrese la 4° calle: ",
										"Error: la calle ingresada es inválida",
										3) == 0) {
									printf("\n[1000] LOMAS"
											"\n[1001] LANUS"
											"\n[1002] BANFIELD"
									...
									if (getInt(&auxLocalidad,
											...
											"Error: la localidad ingresada es inválida",
											1000, 1009, 3) == 0) {
						...
						if (getInt(&idBuscado,
							...
							if ((posicionZonaCensoEncontrada =
								...
								if (getInt(&idBuscado,
										...
										"Error: el ID ingresado es inválido", 1,
										-1, 3) == 0) {
									if ((posicionCensistaEncontrada =
											findCensistaLiberadoById(censistas,
						...
						if (getInt(&idBuscado,
							...
							if ((posicionZonaCensoEncontrada =
								...
								if (getInt(&auxCensadosPresencialmente,
										...
										"Error: la cantidad ingresada es inválida",
										0, -1, 3) == 0) {
				...
				case 9:
					if (hayCensistas(censistas, MAX_CENSISTAS) == 0
						...
						do {
							submenuInformar();
							if (getInt(&opcion,
									"\nIngrese una opción del menú Informes: ",
									"Error: la opción ingresada es inválida", 1,
									6, -1) == 0) {
								switch (opcion) {
								case 1:
