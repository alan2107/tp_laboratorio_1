...
void forcedLoad(Passenger *list1, Flight *list2) {
	...
	strncpy(list1[0].name, "CARLOS", sizeof(list1[0].name));
	strncpy(list1[1].name, "MARTA", sizeof(list1[1].name));
	strncpy(list1[2].name, "ADRIAN", sizeof(list1[2].name));
	strncpy(list1[3].name, "YENI", sizeof(list1[3].name));
	strncpy(list1[4].name, "JONATHAN", sizeof(list1[4].name));
	strncpy(list1[5].name, "FERNANDA", sizeof(list1[5].name));
	strncpy(list1[6].name, "DENIS", sizeof(list1[6].name));
	strncpy(list1[7].name, "FRANCO", sizeof(list1[7].name));
	strncpy(list1[8].name, "ALFRED", sizeof(list1[8].name));
	strncpy(list1[9].name, "MATIAS", sizeof(list1[9].name));

	strncpy(list1[0].lastName, "BAEZ", sizeof(list1[0].lastName));
	strncpy(list1[1].lastName, "BAEZA", sizeof(list1[1].lastName));
	strncpy(list1[2].lastName, "GALLARDO", sizeof(list1[2].lastName));
	strncpy(list1[3].lastName, "TRIGONA", sizeof(list1[3].lastName));
	strncpy(list1[4].lastName, "HERRERA", sizeof(list1[4].lastName));
	strncpy(list1[5].lastName, "PEDEZMONTE", sizeof(list1[5].lastName));
	strncpy(list1[6].lastName, "HERRERA", sizeof(list1[6].lastName));
	strncpy(list1[7].lastName, "GIMENEZ", sizeof(list1[7].lastName));
	strncpy(list1[8].lastName, "TORRES", sizeof(list1[8].lastName));
	strncpy(list1[9].lastName, "TORRES", sizeof(list1[9].lastName));
