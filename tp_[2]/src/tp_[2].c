					...
					if(isThereAPassenger(passengers, MAX_PASSENGERS) == 0) {
						do {
							...
							if(getInt(&subMenuOption, "\nIngrese una opción del submenú Imprimir Informes: ", "Error: la opción ingresada es inválida", 1, 4, -1) == 0) {
										...
										if(getInt(&subMenuOption, "\nIngrese una opción del submenú Imprimir Informes: ", "Error: la opción ingresada es inválida", 1, 4, -1) == 0) {
											...
											case 2:
												if(sortPassengersByCode(passengers, MAX_PASSENGERS, 0) != 0) {
													error("Error: la función sortPassengersByCode falló", "para volver al submenú Imprimir Informes");
													break;
												}
												if(printPassengers(passengers, MAX_PASSENGERS) != 0) {
													error("Error: la función printPassengers falló", "para volver al submenú Imprimir Informes");
													break;
												}
												printf("\n");
												pressAnyKey("para volver al submenú Imprimir Informes");
											...
											error("Error: la función getInt falló", "para volver al submenú Imprimir Informes");
											break;
										}
									} while(subMenuOption != 3);
									break;
								...
								error("Error: la función getInt falló", "para volver al menú Principal");
								break;
							}
